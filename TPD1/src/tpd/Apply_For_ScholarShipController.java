...
import static tpd.Add_Student_ForScholarShipController.isAlpha;
import static tpd.Add_Student_ForScholarShipController.isDigit;
 ...
 * @author Mukaffi
 */
public class Apply_For_ScholarShipController implements Initializable {
 ...
 public static boolean isAlpha(String s) {
    ...
    @FXML
    private void Apply_button(ActionEvent event) {
