 ...
 * @author Mukaffi
 */
public class User_Show_ALL_OrphanController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            User_Show_ALL_OrphanController.orphanList = dbAction.getAllOrphan();

        } catch (SQLException ex) {
            Logger.getLogger(User_Show_ALL_OrphanController.class.getName()).log(Level.SEVERE, null, ex);
        }
