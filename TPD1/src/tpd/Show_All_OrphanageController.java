 ...
 * @author Mukaffi
 */
public class Show_All_OrphanageController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            Show_All_OrphanageController.orphanageList = dbAction.getAllOrphanage();
            for (Orphanage_houses orphan : Show_All_OrphanageController.orphanageList) {
    ...
    private void delete(ActionEvent event) throws SQLException {
        ObservableList<Orphanage_houses> selectedOrphanage = FXCollections.observableArrayList();
        selectedOrphanage = OrphanageTable.getSelectionModel().getSelectedItems();
        DatabaseAction dbAction = new DatabaseAction();
        dbAction.deleteOrphanage(selectedOrphanage);
        orphanageList.removeAll(selectedOrphanage);
