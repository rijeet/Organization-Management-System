 ...
 * @author Mukaffi
 */
public class Add_New_homeController implements Initializable {

    @FXML
    private AnchorPane Add_Orphanage_Ancor;
    @FXML
    ...
    private void Save(ActionEvent event) throws SQLException {
        ...
        if (name.equals("") || upzila.equals("") || vacancy.equals("") || capacity.equals("")) {
            ...
            try {
                ...
                OldAgeHome_Houses or = new OldAgeHome_Houses(name, Dis, upzila, vacancy, capacity);
                System.out.println(or);
                DatabaseAction dbAction = new DatabaseAction();
                dbAction.isertOldAgeHome(or);
                Name.clear();
                Vacancy.clear();
                Capacity.clear();
