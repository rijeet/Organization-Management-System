 ...
 * @author Mukaffi
 */
public class User_Show_All_personController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            User_Show_All_personController.personList = dbAction.getAllOldAgePerson();
            for (Oldagehome old : User_Show_All_personController.personList) {
