 ...
 * @author Mukaffi
 */
public class User_Show_All_ScholarShip_StudentController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       scholarshipList.clear();
        ...
        try {
            ...
            Logger.getLogger(User_Show_All_ScholarShip_StudentController.class.getName()).log(Level.SEVERE, null, ex);
        }
