 ...
 * @author Mukaffi
 */
public class User_DonnorListController implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       // ObservableList<Donor> stdList = null;
            try {
            User_DonnorListController.Dnrlist= dbAction.getAllDonor();
           
            } catch (SQLException ex) {
            Logger.getLogger(User_DonnorListController.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        DonorTable.setItems(User_DonnorListController.Dnrlist);
