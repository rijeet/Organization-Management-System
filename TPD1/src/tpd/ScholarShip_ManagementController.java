 ...
 * @author Mukaffi
 */
public class ScholarShip_ManagementController implements Initializable {
    ...
    private void Show_ScholarShipList(ActionEvent event) throws IOException {
     Parent pane=FXMLLoader.load(getClass().getResource("Show_All_ScholarShip_Student.fxml"));
            Scholarship_Hbox.getChildren().setAll(pane);
    }

    @FXML
    private void Add_ScholarShip(ActionEvent event) throws IOException {
    Parent pane=FXMLLoader.load(getClass().getResource("Add_Student_ForScholarShip.fxml"));
            Scholarship_Hbox.getChildren().setAll(pane);
    }

    @FXML
    private void Request_List(ActionEvent event) throws IOException {
    Parent pane=FXMLLoader.load(getClass().getResource("ShowAll_Apply_Scholarship.fxml"));
            Scholarship_Hbox.getChildren().setAll(pane);
    }
